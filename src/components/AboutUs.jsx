  ...
  return (
    <section className="bg-red-dark w-full text-zinc-100 pt-10">
      <div className="w-full text-center drop-shadow-md relative">
        ...
        <div className="-translate-y-[55%] absolute left-0 right-0 mx-auto w-fit p-0.5 tablet:p-1 bg-red-dark border-solid border-4 tablet:border-8 border-yellow-300 rounded-xl tablet:rounded-3xl">
          <h2 className="border-solid border-4 border-yellow-500 px-6 py-2 tablet:py-3 rounded-md tablet:rounded-xl flex flex-row justify-center">
            About us
          </h2>
        </div>
      </div>
      ...
      >
        <article className="drop-shadow-md">
          <h3 className="underline decoration-orange-400 underline-offset-2 mb-3 laptop:mb-4">
            Who are we
          </h3>
          <p>
